document.addEventListener("DOMContentLoaded", () => {
  try {
    ...
    if (!appEl || !dateEl || !overallBar) {
      console.error("Missing essential elements (#app, #date, #overallBar)");
      return;
    }
    ...
    console.error("Error initializing habit tracker:", err);
    document.body.innerHTML="<h2 style='color:white;'>Failed to load habit tracker</h2>";
  }
});
